...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1455721332L;
    ...
    public final com.growing.sgh.domain.item.entity.QItem item;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new com.growing.sgh.domain.item.entity.QItem(forProperty("item"), inits.get("item")) : null;
    }
