...
import static com.growing.sgh.config.security.constant.SecurityConstants.TOKEN_TYPE;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                .title("sgh shopping mall")
                .description("growing shopping mall")
                .version("1.0")
                .build();
    }

    private ApiKey apiKey(){
        return new ApiKey(TOKEN_TYPE, TOKEN_HEADER, "header");
    }
    ...
    private List<SecurityReference> defaultAuth(){
        ...
        return Arrays.asList(new SecurityReference(TOKEN_TYPE, authorizationScopes));
    }
}
